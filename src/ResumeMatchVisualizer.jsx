...
const ResumeMatchVisualizer = () => {
  ...
  const requirements = [
    { 
      ...
      items: [
        ...
        { 
          name: 'Foundation in object-oriented programming', 
          match: true,
  ...
  // Symmetric Apple Logo SVG Path
  const symmetricApplePath = (
    <>
      {/* Left half of the apple */}
      <path d="M12,7.75 
              C11.32,7.75 10.1,6.86 8.82,6.88
              C7.13,6.91 5.57,7.87 4.7,9.39
              C2.94,12.45 4.25,17 5.96,19.47
              C6.8,20.68 7.79,22.05 9.1,22
              C10.37,21.95 10.84,21.18 12,21.18" 
            fill="currentColor" />
            
      {/* Right half (mirrored from left half) */}
      <path d="M12,7.75 
              C12.68,7.75 13.9,6.86 15.18,6.88
              C16.87,6.91 18.43,7.87 19.3,9.39
              C21.06,12.45 19.75,17 18.04,19.47
              C17.2,20.68 16.21,22.05 14.9,22
              C13.63,21.95 13.16,21.18 12,21.18" 
            fill="currentColor" />
            
      {/* Leaf */}
      <path d="M13,3.5
              C13.73,2.67 14.94,2.04 15.94,2
              C16.07,3.17 15.6,4.35 14.9,5.19
              C14.21,6.04 13.07,6.7 11.95,6.61
